...
%%
%%  Medida en ppt_resultados_IREM_2025_master_logos.PDF, no en el .pptx: el
%%  .pptx no la trae en ninguna parte (ni en las láminas, ni en los layouts,
%%  ni en el slide master), pero el PDF exportado del mismo deck sí, y en las
%%  veinte láminas con el mismo valor al centésimo. Cuando los dos archivos
%%  discrepan, manda el PDF, que es lo que la gente ve.
%%
%%    tope de la franja  182.37 mm PPT → 86.16 mm
%%    azul                 4.70 mm PPT →  2.22 mm
%%    verde                3.43 mm PPT →  1.62 mm
%%
%%  Va en TODAS las láminas, portada incluida.
\newlength{\iremFranjaAzul}\setlength{\iremFranjaAzul}{2.22mm}
\newlength{\iremFranjaVerde}\setlength{\iremFranjaVerde}{1.62mm}
